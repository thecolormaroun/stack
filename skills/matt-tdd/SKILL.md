---
name: matt-tdd
description: 'Namespaced import of Matt Pocock engineering/productivity skills: Test-driven
  development. Use when the user wants to build features or fix bugs test-first, mentions
  "red-green-refactor", or wants integration tests.. Use via $matt-tdd when this upstream
  workflow is needed inside Maroun''s Stack or Hermes-safe operating loop.'
---
## Stack Import

- Invoke this imported skill as `$matt-tdd`.
- Upstream name: `tdd`.
