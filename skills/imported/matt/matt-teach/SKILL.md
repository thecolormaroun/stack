---
name: matt-teach
description: 'Namespaced import of Matt Pocock engineering/productivity skills: Teach
  the user a new skill or concept, within this workspace.. Use via $matt-teach when
...
- Invoke this imported skill as `$matt-teach`.
- Upstream name: `teach`.
