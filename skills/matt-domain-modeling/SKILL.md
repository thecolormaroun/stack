...
description: 'Namespaced import of Matt Pocock engineering/productivity skills: Build
  and sharpen a project''s domain model. Use when the user wants to pin down domain
  terminology or a ubiquitous language, record an architectural decision, or when
  another skill needs to maintain the domain model.. Use via $matt-domain-modeling
