...
description: 'Namespaced import of Matt Pocock engineering/productivity skills: Use
  when you need to resolve an in-progress git merge/rebase conflict.. Use via $matt-resolving-merge-conflicts
  when this upstream workflow is needed inside Maroun''s Stack or Hermes-safe operating
  loop.'
---
## Stack Import

- Invoke this imported skill as `$matt-resolving-merge-conflicts`.
- Upstream name: `resolving-merge-conflicts`.
